...
let river:string= "ravi"
console.log(river==="ravi"|| river==="pond"?true:false)

let bread:string= "dawn"
console.log(bread==="dawn"||bread==="dawn"?true:false)
